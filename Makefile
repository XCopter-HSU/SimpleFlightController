...
# 
ELF := SimpleFlightController.elf

# Paths to C, C++, and assembly source files.
C_SRCS += Drivers/Driver_Accl.c
C_SRCS += Drivers/Driver_Compa.c
C_SRCS += Drivers/Driver_Gyro.c
C_SRCS += Drivers/Driver_I2C.c
C_SRCS += Drivers/Driver_Motor.c
C_SRCS += Drivers/Driver_PWM.c
C_SRCS += Drivers/Driver_RC.c
C_SRCS += Logger.c
C_SRCS += PIDs/PIDMotorMapper.c
C_SRCS += PIDs/PIDPitch.c
C_SRCS += PIDs/PIDRoll.c
C_SRCS += PIDs/PIDYaw.c
C_SRCS += RCReceiver.c
C_SRCS += SensorDataFilter.c
C_SRCS += SensorDataManager.c
C_SRCS += main.c
CXX_SRCS :=
ASM_SRCS :=
...
BSP_ROOT_DIR := ../SimpleFlightController_bsp/
