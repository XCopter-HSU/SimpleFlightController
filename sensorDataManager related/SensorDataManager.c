...
void SensorDataManager(){
	...
	while(1){
		...
		// OSTimeDlyHMSM(0, 0, 0, 1); //uncomment if sensordata reading is to highfrequent-> set delay to apropirat value
	}
}
...
int8_t initSensors(){
	...
	return err1 & err2 & err3; //dont know how to return multiple erroros
